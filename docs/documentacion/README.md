...
* [01. Especificación de API REST y Enlace de Datos](./02-backend-servicios/01-especificacion-api-rest.md): Catálogo completo y exhaustivo de los 22 controladores de la API (`PeaController`, `DocumentInstancesController`, `SignaturesController`, etc.), rutas HTTP, DTOs y serialización `snake_case`.
