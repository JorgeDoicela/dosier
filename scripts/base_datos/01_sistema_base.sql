...
('DocumentMaintenance.RetentionDays', '1825',              'Cantidad de días de retención legal para evidencias físicas de documentos curriculares y PEA del CACES (por defecto 5 años / 1825 días).'),
...
CREATE TABLE doc_document_templates (
    ...
    code                    VARCHAR(100)  NOT NULL UNIQUE COMMENT 'Código único (ej: PEA_OFICIAL)',
