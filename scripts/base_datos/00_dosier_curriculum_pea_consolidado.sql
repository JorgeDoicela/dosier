-- =============================================================================
-- SISTEMA DOSIER: GESTIÓN CURRICULAR Y ACREDITACIÓN INSTITUCIONAL (ISTPET)
-- MODELO RELACIONAL CONSOLIDADO - PROGRAMA DE ESTUDIO DE LA ASIGNATURA (PEA)
-- 
-- Base de Datos: sigafi_es | Motor: MySQL 8.0+ / MariaDB 10.5+ | Prefijo: 'doc_'
-- Enfoque: 100% Procesos de Negocio Curricular y Requerimientos Institucionales
-- Sin UUIDs | Sin Triggers | Sin Vistas | Sin Seeders | Sin WebSockets | Sin Magic Links
-- =============================================================================
...
-- =============================================================================
-- BLOQUE 2: CONTENEDOR MAESTRO Y GESTIÓN DE EXPEDIENTES CURRICULARES
-- =============================================================================

-- 8. Expediente Curricular Maestro: Agrupador oficial por Asignatura, Período y Carrera
...
-- 9. Mapeo de asignaciones docentes y paralelos al expediente de la materia (Cátedra Compartida)
...
-- 19. Historial Inmutable de Trazabilidad de Estados y Auditoría Forense
...
-- 20. Registro Formal de Firmas Digitales de Responsabilidad (Ley de Comercio Electrónico Ecuador)
...
-- =============================================================================
-- BLOQUE 5: SEGURIDAD RBAC CURRICULAR INSTITUCIONAL (REFERENCIA ARQUITECTÓNICA)
-- =============================================================================
...
-- 2. Cinco Roles Oficiales Curriculares:
--    - DOSIER_ADMIN: Administrador general y aseguramiento de la calidad curricular.
--    - DOSIER_DOCENTE: Docente elaborador y autor del PEA.
--    - DOSIER_COORD_CARRERA: Coordinador de Carrera (Revisión de pertinencia disciplinar).
--    - DOSIER_COORD_ACAD: Coordinación Académica (Verificación metodológica institucional).
--    - DOSIER_VICERRECTOR: Vicerrectorado (Aprobación legal definitiva y cierre oficial).
-- =============================================================================
